...
public class Enemy : MonoBehaviour
{
    ...
    private boolean longWays = false;
    ...
    public float detectionAngle = 70.f;
    ...
    void Update ()
    {
        ...
        if (preChase == 0)
        {
            ...
            */
            ...
            transform.position = Vector3.MoveTowards(transform.position, patrolPoints[targetPoint], moveSpeed * Time.deltaTime);
        }
    }

    int changeTargetInt()
    {
        newVal = Random.Range(0,6);
        return newVal;
    }
